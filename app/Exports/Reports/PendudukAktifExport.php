...
class PendudukAktifExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithTitle, WithEvents
{
    ...
    {
        $tgl = $row->tgl_lahir ? \Carbon\Carbon::parse($row->tgl_lahir)->format('Y-m-d') : '-';
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A4', 'LAPORAN DATA PENDUDUK AKTIF');
